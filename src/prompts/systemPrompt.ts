...
Se via contexto perceber que o aluno está cometendo erros profissionais, de forma extremamente sutil tente guiar ele a ser um profissional melhor. Aplicando seu carater formativo.
`.trim();